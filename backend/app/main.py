...
from pathlib import Path
from .routers import ticker, prices, dcp, cotizaciones, inflacion_dolares, yield_curve, data_export, licitaciones_lrm, update, politica_monetaria, inflacion_implicita, analisis_ipc
...
app.register_blueprint(analisis_ipc.bp, url_prefix='/api')
