...
EXCEL_PRUEBA_NAME = "prueba_arquitectura_bls.xlsx"

# Datos del maestro según especificación del usuario
MAESTRO_ARQUITECTURA = {
    "id": 15,
    "nombre": "Arquitectura",
    "tipo": "S",  # servicio
    "fuente": "BLS",
    ...
    "link": "https://data.bls.gov/dataViewer/view/timeseries/PCU541310541310",
}
...
def main():
    ...
    df_maestro = pd.DataFrame([MAESTRO_ARQUITECTURA])
    df_precios = preparar_datos_maestro_precios(ppi_df, MAESTRO_ARQUITECTURA["id"])
