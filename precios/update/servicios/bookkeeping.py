...
para Bookkeeping and Payroll Services (NAICS 541219) del BLS,
...
Serie BLS: PCU541219541219
Descripción: Producer Price Index for Bookkeeping and Payroll Services
Base: Dec 2000 = 100
...
BLS_SERIES_ID = "PCU541211541211A"  # Other accounting services (tiene datos desde 2008)
BLS_START_YEAR = 2010
BLS_END_YEAR = datetime.now().year

# Configuración de base de datos y archivos de salida
DB_NAME = "series_tiempo.db"
EXCEL_PRUEBA_NAME = "prueba_bookkeeping_bls.xlsx"

# Datos del maestro según especificación del usuario
MAESTRO_BOOKKEEPING = {
    "id": 17,
    "nombre": "Bookkeeping / payroll",
    "tipo": "S",  # servicio
    "fuente": "BLS",
    ...
    "link": "https://data.bls.gov/dataViewer/view/timeseries/PCU541211541211A",
}
...
def main():
    print("=" * 60)
    print("ACTUALIZACION DE DATOS: BOOKKEEPING / PAYROLL (BLS)")
    print("=" * 60)
    ...
    df_maestro = pd.DataFrame([MAESTRO_BOOKKEEPING])
    df_precios = preparar_datos_maestro_precios(ppi_df, MAESTRO_BOOKKEEPING["id"])
