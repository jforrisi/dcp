...
para Engineering Services (NAICS 541330) del BLS,
...
Serie BLS: PCU541330541330
Descripción: Producer Price Index for Engineering Services
Base: Dec 2000 = 100
...
MAESTRO_INGENIERIA = {
    ...
    "link": "https://data.bls.gov/dataViewer/view/timeseries/PCU541330541330",
}
...
def main():
    print("=" * 60)
    print("ACTUALIZACION DE DATOS: INGENIERIA (BLS)")
    print("=" * 60)
    ...
    df_maestro = pd.DataFrame([MAESTRO_INGENIERIA])
    df_precios = preparar_datos_maestro_precios(ppi_df, MAESTRO_INGENIERIA["id"])
