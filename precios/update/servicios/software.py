...
para Data Processing and Related Services (NAICS 518210) del BLS,
siguiendo el flujo del README:

1) Obtener datos desde la API de BLS v1 (sin registro requerido).
2) Validar fechas.
3) Generar Excel de prueba.
4) Actualizar automáticamente la base de datos.

Serie BLS: PCU513210513210
Descripción: Producer Price Index for Software publishers
Base: Dec 2000 = 100
...
BLS_SERIES_ID = "PCU513210513210"  # Software publishers (tiene datos desde 1997)
BLS_START_YEAR = 2010  # Datos desde enero 2010
BLS_END_YEAR = datetime.now().year

# Configuración de base de datos y archivos de salida
DB_NAME = "series_tiempo.db"
EXCEL_PRUEBA_NAME = "prueba_software_bls.xlsx"

# Datos del maestro según especificación del usuario
MAESTRO_SOFTWARE = {
    "id": 13,  # siguiente ID disponible
    "nombre": "Software",
    "tipo": "S",  # servicio
    "fuente": "BLS",
    ...
    "link": "https://data.bls.gov/dataViewer/view/timeseries/PCU513210513210",
}
...
def main():
    ...
    df_maestro = pd.DataFrame([MAESTRO_SOFTWARE])
    df_precios = preparar_datos_maestro_precios(ppi_df, MAESTRO_SOFTWARE["id"])
