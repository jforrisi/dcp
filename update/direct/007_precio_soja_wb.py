...
ID_VARIABLE = 18  # Soja (desde maestro_database.xlsx Sheet1_old)
...
def main():
    ...
    soja_df = validar_fechas_solo_nulas(soja_df)
    ...
    insertar_en_bd_unificado(ID_VARIABLE, ID_PAIS, soja_df, DB_NAME)
