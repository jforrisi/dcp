...
------------------------------
Descarga el Excel de precio leche productor de INALE
...
FILENAME_INALE = "Precio-leche-en-tambo-y-composicion.xlsx"
...
def limpiar_archivos_anteriores(data_raw_path: str):
    ...
    for archivo in os.listdir(data_raw_path):
        ...
        if (archivo_lower.startswith("precio-leche-en-tambo") or 
            archivo_lower.startswith("precio_leche_productor")) and \
