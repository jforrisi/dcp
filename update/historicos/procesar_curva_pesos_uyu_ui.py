"""
Script para procesar curva_pesos_uyu_ui.xlsx:
- Convertir fechas de texto a datetime
- Dividir valores numéricos entre 100000
- Guardar como curva_pesos_uyu_ui_con_fechas.xlsx
"""
...
# Rutas
archivo_original = "curva_pesos_uyu_ui.xlsx"
archivo_nuevo = "curva_pesos_uyu_ui_con_fechas.xlsx"
...
print("=" * 80)
print("PROCESAMIENTO DE CURVA_PESOS_UYU_UI.XLSX")
print("=" * 80)
...
print(f"[OK] Archivo leído: {len(df)} filas, {len(df.columns)} columnas")
...
print(f"[OK] Primeros valores después de dividir:")
print(df.head())
...
print(f"[INFO] Rango de fechas: {df[columna_fecha].min()} a {df[columna_fecha].max()}")
print("=" * 80)
